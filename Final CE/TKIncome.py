...
class income_outcome(tk.Tk):
    ...
    def เพิ่มค่าใช้จ่าย(x):
        ...
        รายละเอียด = x.ค่าใช้จ่าย_รายละเอียด_entry.get()
        x.ค่าใช้จ่าย += จำนวน
    ...
    def หน้าต่าง(x):
        x.รายได้_label = tk.Label(x , text="รายได้ทั้งหมด : 0.0 บาท", font=("Tahoma", 15, "bold"))
        x.รายได้_label.pack(pady=5)
        x.รายได้_entry = tk.Entry(x)
        x.รายได้_entry.pack()
        x.รายได้_button = tk.Button(x, text="เพิ่มรายได้", command=x.เพิ่มรายได้, width=10, font=("Tahoma", 11, "bold"), bg="Lemon chiffon1")
        x.รายได้_button.pack(pady = 10)

        x.ค่าใช้จ่าย_label = tk.Label(x, text="ค่าใช้จ่ายทั้งหมด : 0.0 บาท", font=("Tahoma", 15, "bold"))
        x.ค่าใช้จ่าย_label.pack()
        x.ค่าใช้จ่าย_entry = tk.Entry(x)
        x.ค่าใช้จ่าย_entry.pack()
        x.ค่าใช้จ่าย_รายละเอียด_label = tk.Label(x, text="รายละเอียดค่าใช้จ่าย", font=("Tahoma", 15, "bold"))
        x.ค่าใช้จ่าย_รายละเอียด_label.pack()
        x.ค่าใช้จ่าย_รายละเอียด_entry = tk.Entry(x)
        x.ค่าใช้จ่าย_รายละเอียด_entry.pack()
        x.ค่าใช้จ่าย_button = tk.Button(x, text="เพิ่มค่าใช้จ่าย", command=x.เพิ่มค่าใช้จ่าย, width=10, font=("Tahoma", 11, "bold"), bg="Mintcream")
        x.ค่าใช้จ่าย_button.pack(pady = 10)

        x.รายได้สุทธิ_label = tk.Label(x, text="รายได้สุทธิ : 0.0 บาท", font=("Tahoma", 15, "bold"))
        x.รายได้สุทธิ_label.pack()
        x.แสดงสรุป_button = tk.Button(x, text="แสดงสรุป" , command=x.แสดงสรุป, width=10, font=("Tahoma", 11, "bold"), bg="Lavender")
        x.แสดงสรุป_button.pack(pady = 5)
